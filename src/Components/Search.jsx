...
import bgtech2 from './../assets/Images/bgtech2.png'
    ...
    return(
      ...
      <div className="flex justify-center mt-8 flex-col px-[70] md:px-[150px]">
           ...
           <div className='flex gap-10 justify-center mt-5 '>
               {tags.map((item,index)=>( <ul key={item.id} onClick={()=>setActiveIndex(index)}
                                           className={`${index==activeIndex?'bg-blue-500 text-black':null} p-1 pb-2
                                                             rounded-sm  md:rounded-full cursor-pointer md:px-4
                                                             hover:scale-110 hover:border-[1px] border-blue-500
